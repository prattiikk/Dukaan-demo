  ...
  return (
    <div className="w-full mt-0">
      ...
      <div className="w-full px-4 py-2 bg-white shadow rounded-md">
        ...
        <div className="w-full h-[40px] rounded-md flex items-center justify-between text-sm text-stone-600  font-medium bg-stone-200 bg-opacity-60 px-4">
